...
const PAGE_CONTENT = {
  ...
  "/phrases/": `
    ...
    <section><h2>Browse phrase collections by research-paper task</h2><div class="seo-grid"><article><h3><a href="/phrases/introduction/">Introduction phrases</a></h3><p>Move from context to a research gap, purpose, and focused question.</p></article><article><h3><a href="/phrases/methods/">Methods phrases</a></h3><p>Describe a design, data collection, participants, and analysis with appropriately precise language.</p></article><article><h3><a href="/phrases/results/">Results phrases</a></h3><p>Report findings, tables, and statistical patterns without moving too early into discussion.</p></article><article><h3><a href="/phrases/discussion/">Discussion phrases</a></h3><p>Interpret results, state limits, and frame implications cautiously.</p></article><article><h3><a href="/blog/how-to-use-hedging-language-in-academic-writing/">Hedging language</a></h3><p>Choose measured language when the evidence suggests rather than proves a claim.</p></article></div></section>
