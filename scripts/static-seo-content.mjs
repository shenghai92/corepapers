...
const PAGE_CONTENT = {
  ...
  "/polish/": `
    ...
    <p class="lead">Paste an essay, report, or research paragraph to review wording, sentence structure, stance, and formality choices before you submit.</p>
    <p><a class="button" href="/login/">Start free</a></p>
    <section><h2>What Essay Polish helps you review</h2><ul><li><strong>Language-influenced phrasing:</strong> wording or sentence patterns that may be literal, unclear, or less suitable for the academic context you choose.</li><li><strong>More precise wording:</strong> revision options you can compare with the meaning, evidence, and discipline-specific convention of your own draft.</li><li><strong>Revision explanations:</strong> feedback that helps you decide whether to accept, adapt, or reject a change and learn from it.</li></ul></section>
    <section><h2>Use it after you have written the idea</h2><p>Start with your own draft. The optional sample is a <strong>fictional learning sample</strong>, not text to submit unchanged. Review every suggestion carefully, preserve the meaning you intend, and check that any source-based claims still have accurate citations.</p></section>
    <section><h2>What an essay polisher cannot decide</h2><p>A language suggestion cannot confirm that a claim is true, judge whether evidence supports your conclusion, verify a source, or determine what your university permits. You remain responsible for your argument, sources, citations, assignment requirements, and academic-integrity policy.</p></section>
    <section class="seo-grid"><article><h2>Build a revision routine</h2><p>Revise argument, paragraph flow, clarity, tone, and source use one focused layer at a time.</p><p><a href="/blog/how-to-improve-academic-writing-skills-for-international-students/">Read the Academic Writing Skills guide</a></p></article><article><h2>Check the paragraph before polishing</h2><p>Make sure a clearer sentence still supports a focused claim, relevant evidence, and explanation.</p><p><a href="/academic-paragraph-structure/">Use the paragraph structure guide</a></p></article><article><h2>Keep source use clear</h2><p>Retain citations and verify source-based claims after revising a paragraph.</p><p><a href="/academic-integrity-and-source-use/">Read the source-use guide</a></p></article></section>
    ${tools}`,
  "/phrases/": `
