...
expect(introductionPracticeHtml.includes("Align the route with final paper"), "introduction practice: final-scope workflow step");
...
expect(discussionPracticeHtml.includes("Explain bounded meaning"), "discussion practice: bounded-meaning workflow step");
expect(discussionPracticeHtml.includes("End with proportionate implication"), "discussion practice: bounded-implication workflow step");
...
expect(conclusionPracticeHtml.includes("Remove new material"), "conclusion practice: new-material boundary");
expect(conclusionPracticeHtml.includes("writingcenter.unc.edu/tips-and-tools/conclusions"), "conclusion practice: UNC guidance link");
