      ...
      <main className="min-h-screen bg-background pt-24 pb-16">
        <div className="container max-w-5xl">
          ...
          <section className="mt-8 p-7 bg-white border border-border rounded-2xl">
            ...
            <p className="text-sm font-sans text-muted-foreground leading-relaxed"><a className="text-primary underline underline-offset-4" href="https://gsc.upenn.edu/strengthen-your-academic-writing" target="_blank" rel="noreferrer">University of Pennsylvania&apos;s Graduate Student Center</a> recommends early attention to purpose, key terms, scope, evidence, real-time reference tracking, and paragraph-level argument and support. <a className="text-primary underline underline-offset-4" href="https://poorvucenter.yale.edu/writing/writing-resources-for-graduate-students" target="_blank" rel="noreferrer">Yale&apos;s Graduate Writing Lab</a> organizes support by genres, style and conventions, writing skills, integrity, and discipline-specific needs. <a className="text-primary underline underline-offset-4" href="https://grad.berkeley.edu/students/graduate-writing-center/" target="_blank" rel="noreferrer">UC Berkeley&apos;s Graduate Writing Community</a> highlights weekly goals and a regular writing routine as support for long projects. <a className="text-primary underline underline-offset-4" href="https://asc.dasa.ncsu.edu/undergraduate-writing-center/graduate-writing-center/" target="_blank" rel="noreferrer">NC State&apos;s Graduate Writing Center</a> describes support across stages from brainstorming to revision while maintaining that the writer remains responsible for the work. Follow your programme&apos;s actual rules where they differ.</p>
          </section>
