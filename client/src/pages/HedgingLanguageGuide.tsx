      ...
      <main className="min-h-screen bg-background pt-24 pb-16">
        <div className="container max-w-5xl">
          ...
          <section className="mt-8 p-7 bg-hero-gradient border border-border rounded-2xl">
            ...
            <h2 className="font-serif text-3xl text-slate-purple mb-5">An eight-step claim-to-certainty workflow</h2>
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
              <article className="rounded-xl bg-white/80 border border-white p-5"><p className="text-xs font-sans font-semibold text-primary mb-2">STEP 1 · FUNCTION</p><h3 className="font-serif text-xl text-slate-purple mb-2">Name the claim&apos;s job</h3><p className="text-sm font-sans text-muted-foreground leading-relaxed">Decide whether sentence reports description, association, difference, mechanism, evaluation, interpretation, or causal effect before changing any word.</p></article>
              <article className="rounded-xl bg-white/80 border border-white p-5"><p className="text-xs font-sans font-semibold text-primary mb-2">STEP 2 · TRACE</p><h3 className="font-serif text-xl text-slate-purple mb-2">Reopen the evidence</h3><p className="text-sm font-sans text-muted-foreground leading-relaxed">Check the study, data, source passage, or analysis that supports the claim. A hedge cannot repair missing evidence or inaccurate attribution.</p></article>
              <article className="rounded-xl bg-white/80 border border-white p-5"><p className="text-xs font-sans font-semibold text-primary mb-2">STEP 3 · BOUND</p><h3 className="font-serif text-xl text-slate-purple mb-2">State the real scope</h3><p className="text-sm font-sans text-muted-foreground leading-relaxed">Name the population, period, setting, method, source base, or condition that bounds the claim instead of implying universality.</p></article>
              <article className="rounded-xl bg-white/80 border border-white p-5"><p className="text-xs font-sans font-semibold text-primary mb-2">STEP 4 · TEST</p><h3 className="font-serif text-xl text-slate-purple mb-2">Check the relationship</h3><p className="text-sm font-sans text-muted-foreground leading-relaxed">Distinguish association, comparison, description, prediction, and causation. Do not use stronger relation than design and evidence allow.</p></article>
              <article className="rounded-xl bg-white/80 border border-white p-5"><p className="text-xs font-sans font-semibold text-primary mb-2">STEP 5 · CHALLENGE</p><h3 className="font-serif text-xl text-slate-purple mb-2">Look for exceptions</h3><p className="text-sm font-sans text-muted-foreground leading-relaxed">Ask whether reasonable readers could point to alternative explanations, missing data, conflicting sources, or cases the statement does not cover.</p></article>
              <article className="rounded-xl bg-white/80 border border-white p-5"><p className="text-xs font-sans font-semibold text-primary mb-2">STEP 6 · PRECISE</p><h3 className="font-serif text-xl text-slate-purple mb-2">Fix logic before hedging</h3><p className="text-sm font-sans text-muted-foreground leading-relaxed">Prefer a narrower noun, exact verb, stated quantity, clear comparison, or source attribution before adding a modal or adverb.</p></article>
              <article className="rounded-xl bg-white/80 border border-white p-5"><p className="text-xs font-sans font-semibold text-primary mb-2">STEP 7 · CALIBRATE</p><h3 className="font-serif text-xl text-slate-purple mb-2">Choose certainty and distance</h3><p className="text-sm font-sans text-muted-foreground leading-relaxed">Use a modal, quantifier, frequency word, reporting verb, or source-distance expression only when it matches the remaining uncertainty.</p></article>
              <article className="rounded-xl bg-white/80 border border-white p-5"><p className="text-xs font-sans font-semibold text-primary mb-2">STEP 8 · RE-READ</p><h3 className="font-serif text-xl text-slate-purple mb-2">Check reader responsibility</h3><p className="text-sm font-sans text-muted-foreground leading-relaxed">Read the revised sentence in its paragraph, verify citation and local conventions, and keep only wording you can explain as your evidence-led judgment.</p></article>
            </div>
            <div className="mt-6 rounded-xl bg-white/80 border border-white p-5 text-sm font-sans text-muted-foreground leading-relaxed"><p className="font-serif text-xl text-slate-purple mb-3">Choose the function before the phrase</p><p><strong>Possible explanation:</strong> may reflect, could be associated with, might be explained by. <strong>Evidence-led interpretation:</strong> suggests, appears to indicate, is consistent with, points to. <strong>Frequency or scope:</strong> often, generally, in some cases, among the participants surveyed, within the studies reviewed. <strong>Careful comparison:</strong> differs from, may extend, partly aligns with, offers one account of. <strong>Bounded implication:</strong> may inform, warrants further examination, provides a basis for, should be interpreted in light of.</p></div>
          </section>
          ...
          <section className="mt-8 p-7 bg-hero-gradient border border-border rounded-2xl">
            ...
            <p className="text-sm font-sans text-muted-foreground leading-relaxed mb-5"><strong>This fictional learning example is invented for practice; it is not student work, research evidence, or text to submit.</strong> The study, sample, evidence, finding, citation, and revision below are not real research and must not be used as a source or submitted as evidence.</p>
