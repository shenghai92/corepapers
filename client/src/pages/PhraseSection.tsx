  ...
  "literature-review": {
    ...
    deepDive: {
      ...
      steps: [
        ...
        { title: "5. Write a cross-source theme claim", text: "Use a synthesis phrase to state the relationship you have established across sources, then anchor the claim in traceable citations and explain why that relationship matters to the organizing question. Keep your own analytical voice visible." },
        { title: "6. Preserve disagreement, exceptions, and limits", text: "Include a relevant conflicting result, methodological difference, boundary condition, narrow source base, or unresolved issue instead of turning a partial pattern into consensus. Do not explain a disagreement with a method difference unless the evidence supports that inference." },
        { title: "7. State a bounded research limitation or next question", text: "Describe limited, uneven, conflicting, or underexplored evidence only after reviewing an appropriate body of work. Name the defined population, context, method, relationship, outcome, or condition and frame a feasible next question without claiming that no research exists." },
        { title: "8. Verify attribution and review boundaries", text: "Check each source-based statement against the actual source, place citations near the supported claim, distinguish source findings from your synthesis, and follow assignment rules for review section, annotated bibliography, argument paper, or proposal." },
      ],
      ...
      authorityText: "UNC Writing Center distinguishes a literature review's source summary from synthesis: synthesis reorganizes information, may trace intellectual progression or debate, and is generally organized around ideas rather than authors. University of Oregon Libraries defines synthesis as combining multiple sources to make a point and showing how sources converse; it specifies that synthesis is not a sequence of summaries, a simple comparison, or direct quotation without the writer's own voice. Johns Hopkins Libraries explains that a synthesis matrix records source main points and relationships so writers can arrange materials by themes or variables before weaving a narrative. Follow the assignment, discipline, instructor, journal, and style requirements for review scope, source selection, evaluation, critique, citation, and section organization.",
      authorityLinks: [
        ...
        { href: "https://researchguides.uoregon.edu/litreview/synthesize", label: "Read University of Oregon Libraries' synthesis guidance" },
        { href: "https://guides.library.jhu.edu/lit-review/synthesize", label: "Read Johns Hopkins Libraries' synthesis guidance" },
      ],
      evidenceDecision: {
        title: "Choose a Literature Review phrase only after you identify the source relationship",
        intro: "A phrase can help readers follow a relationship you have established among sources. It cannot transform separate summaries into synthesis, make a small source set represent a field, manufacture a disagreement or gap, transfer a finding between contexts, or replace precise citation and accurate paraphrase.",
        cards: [
          { title: "Organize a thematic synthesis", text: "Use a shared-pattern phrase after arranging sources by a question, theme, method, variable, debate, or other lens. Explain the actual relationship instead of placing several author names in the same sentence." },
