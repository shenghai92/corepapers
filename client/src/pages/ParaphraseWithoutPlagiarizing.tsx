...
const STEPS = [
  [FileSearch, "1. Record the original source", "Before drafting, save the author or organization, title, container, version, date, page or locator, stable link, and required style details. Do not rely on memory or generated metadata later."],
  [BookOpenCheck, "2. Understand the source first", "Read enough to explain the source’s point, evidence, qualifications, scope, and context accurately. If you cannot explain the idea, you are not ready to paraphrase it."],
  [Waypoints, "3. Decide why your paragraph needs it", "Choose the aspect that supports your own claim, context, comparison, limitation, or analysis. A paraphrase should serve the paragraph’s purpose, not reproduce every detail."],
  [Quote, "4. Set the source aside and rebuild", "Without looking at the source sentence, explain the selected meaning in a new structure, sequence, and emphasis that fit your point. Do not swap words one by one or preserve the original route."],
  [BookOpenCheck, "5. Compare for accuracy and distance", "Reopen the original and correct any shift in claim, qualification, evidence, population, setting, period, or meaning. Ensure the rewrite is new in form without changing what the source can show."],
  [Quote, "6. Mark exact or distinctive wording", "Keep unavoidable technical terms or names where needed; put distinctive borrowed wording in quotation marks and follow the course or style guidance for a direct quotation."],
  [ShieldCheck, "7. Attribute where the borrowed idea appears", "Add required in-text, note, or other citation at the point readers need to identify the source. Do not let a sequence of source-based ideas lose clear attribution after one opening mention."],
  [ShieldCheck, "8. Reverse-check before submission", "Compare source, notes, paraphrase, quotation marks, citation placement, and complete reference entry; ask the instructor, supervisor, writing center, or library when the requirement is uncertain."],
] as const;
      ...
      <main className="min-h-screen bg-background pt-24 pb-16">
        <div className="container max-w-5xl">
          ...
          <section className="mt-8 p-7 bg-hero-gradient border border-border rounded-2xl">
            ...
            <p className="text-sm font-sans text-muted-foreground leading-relaxed mb-5"><strong className="text-foreground">This fictional learning example is invented for practice:</strong> the source text, author, study, result, citation, paragraph, paraphrase, and bibliographic details do not exist and must not be cited, copied, or treated as research evidence.</p>
          ...
          <section className="mt-8 grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <Link href="/evaluate-academic-sources" className="block"><article className="h-full p-6 bg-hero-gradient border border-border rounded-2xl hover:border-primary/30"><h2 className="font-serif text-2xl text-slate-purple mb-2">Reopen the original source</h2><p className="text-sm font-sans text-muted-foreground leading-relaxed">Verify authorship, version, scope, method, evidence, and the precise claim the paraphrase asks it to support.</p></article></Link>
            <Link href="/academic-argument-evidence" className="block"><article className="h-full p-6 bg-hero-gradient border border-border rounded-2xl hover:border-primary/30"><h2 className="font-serif text-2xl text-slate-purple mb-2">Explain the source&apos;s relevance</h2><p className="text-sm font-sans text-muted-foreground leading-relaxed">Place a paraphrase in a claim–evidence–reasoning chain rather than letting cited material stand alone.</p></article></Link>
            <Link href="/academic-paragraph-structure" className="block"><article className="h-full p-6 bg-hero-gradient border border-border rounded-2xl hover:border-primary/30"><h2 className="font-serif text-2xl text-slate-purple mb-2">Keep one source move visible</h2><p className="text-sm font-sans text-muted-foreground leading-relaxed">Check the paragraph’s point, citation scope, explanation, limitation, and connection after integrating a paraphrase.</p></article></Link>
          </section>
