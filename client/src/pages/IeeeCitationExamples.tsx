      ...
      <main className="min-h-screen bg-background pt-24 pb-16">
        <div className="container max-w-5xl">
          ...
          <section className="mt-8 p-7 bg-hero-gradient border border-border rounded-2xl">
            ...
            <p className="text-sm font-sans text-muted-foreground leading-relaxed mb-5"><strong>This fictional learning example is invented for practice; it is not student work, research evidence, or a reference list to submit.</strong> All names, titles, venues, dates, pages, identifiers, findings, and examples below are invented for learning. They are not real sources, do not validate a factual claim, and must not be copied into a submitted reference list.</p>
          ...
          <section className="mt-8 grid lg:grid-cols-2 gap-6">
            <article className="p-7 bg-white border border-border rounded-2xl"><h2 className="font-serif text-3xl text-slate-purple mb-4">An eight-step IEEE check before submission</h2><ul className="space-y-3 text-sm font-sans text-muted-foreground leading-relaxed">{["Confirm the required IEEE variant and submission rule for your course, journal, conference, or publisher before copying a template.", "Open the original work you actually used and identify its source type, version, container, and any fields the required guide calls for.", "Mark every source-based sentence, including paraphrases, data, methods, images, tables, and exact wording.", "Assign a bracket number at first use, then reuse that same number for the same work rather than creating a duplicate entry.", "For direct quotation or a highly specific passage, check whether a page, section, figure, equation, chapter, or other locator is required or useful.", "Read the manuscript and reference list from [1] onward; confirm sequence, repeated-source reuse, one work per number, and full in-text-to-list coverage.", "Compare each field with the source record and official IEEE examples; do not invent missing authors, dates, titles, pages, venues, DOI, URL, or access details.", "Read as your reader before submission: verify source support, citation placement, current local instructions, and every reference you can take responsibility for."] .map((item, index) => <li key={item} className="flex gap-3"><span className="text-primary font-semibold shrink-0">{index + 1}.</span>{item}</li>)}</ul></article>
