        ...
        <div className="container">
          ...
          <section className="max-w-5xl mx-auto mt-10 p-8 bg-white border border-border rounded-2xl">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <article className="rounded-xl bg-muted/50 p-5"><p className="text-xs font-sans font-semibold text-primary mb-2">STEP 2 · READER</p><h3 className="font-serif text-xl text-slate-purple mb-2">Name reader and purpose</h3><p className="text-sm font-sans text-muted-foreground leading-relaxed">Decide what your reader needs and whether you are arguing, analyzing, evaluating, explaining, or reporting before choosing a more formal phrase.</p></article>
              <article className="rounded-xl bg-muted/50 p-5"><p className="text-xs font-sans font-semibold text-primary mb-2">STEP 3 · IDEAS</p><h3 className="font-serif text-xl text-slate-purple mb-2">Plan argument and evidence</h3><p className="text-sm font-sans text-muted-foreground leading-relaxed">Make question, claim, evidence, explanation, and paragraph sequence visible so language choices have a clear job.</p></article>
          ...
          <section className="max-w-5xl mx-auto mt-6 grid lg:grid-cols-2 gap-6">
            <article className="p-8 bg-hero-gradient border border-border rounded-2xl">
              ...
              <p className="text-sm text-muted-foreground font-sans leading-relaxed"><strong className="text-foreground">This fictional learning example is invented for practice; it is not student work, research evidence, or text to submit.</strong> A multilingual writer drafts: “The survey proves students are stress.” Before searching for a more formal synonym, the writer checks the result, revises the meaning to “The survey responses suggest that some participants reported stress,” and then decides whether the evidence, participant group, and study design support that sentence. The next revision can address grammar and wording without turning a limited finding into a stronger claim.</p>
            </article>
