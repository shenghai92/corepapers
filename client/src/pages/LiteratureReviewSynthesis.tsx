      ...
      <main className="min-h-screen bg-background pt-24 pb-16">
        <div className="container">
          ...
          <section className="max-w-5xl mx-auto mt-7 p-7 bg-white border border-border rounded-2xl">
            ...
            <h2 className="font-serif text-3xl text-slate-purple mb-5">An eight-step matrix-to-synthesis workflow</h2>
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
              <article className="rounded-xl bg-muted/50 p-5"><p className="text-xs font-sans font-semibold text-primary mb-2">STEP 1 · SCOPE</p><h3 className="font-serif text-xl text-slate-purple mb-2">Set question and boundary</h3><p className="text-sm text-muted-foreground font-sans leading-relaxed">Define question, review purpose, source types, time range, discipline, and assignment expectations before adding notes.</p></article>
              <article className="rounded-xl bg-muted/50 p-5"><p className="text-xs font-sans font-semibold text-primary mb-2">STEP 2 · RECORD</p><h3 className="font-serif text-xl text-slate-purple mb-2">Keep sources traceable</h3><p className="text-sm text-muted-foreground font-sans leading-relaxed">Record citation or stable identifier with relevant claims, methods, context, findings, limits, and the exact source location you need to revisit.</p></article>
              <article className="rounded-xl bg-muted/50 p-5"><p className="text-xs font-sans font-semibold text-primary mb-2">STEP 3 · EXTRACT</p><h3 className="font-serif text-xl text-slate-purple mb-2">Select evidence for question</h3><p className="text-sm text-muted-foreground font-sans leading-relaxed">Keep only material that helps answer, frame, complicate, or explain your focused question; distinguish quotation, paraphrase, and your own note.</p></article>
              <article className="rounded-xl bg-muted/50 p-5"><p className="text-xs font-sans font-semibold text-primary mb-2">STEP 4 · CODE</p><h3 className="font-serif text-xl text-slate-purple mb-2">Compare like with like</h3><p className="text-sm text-muted-foreground font-sans leading-relaxed">Use columns or tags for themes, variables, methods, population, setting, evidence type, and limitation so distinctions remain visible.</p></article>
              <article className="rounded-xl bg-muted/50 p-5"><p className="text-xs font-sans font-semibold text-primary mb-2">STEP 5 · GROUP</p><h3 className="font-serif text-xl text-slate-purple mb-2">Find relationships and differences</h3><p className="text-sm text-muted-foreground font-sans leading-relaxed">Group notes by shared pattern, contrast, trend, method, or condition. Reopen the original source whenever a note or relationship is unclear.</p></article>
              <article className="rounded-xl bg-muted/50 p-5"><p className="text-xs font-sans font-semibold text-primary mb-2">STEP 6 · CHALLENGE</p><h3 className="font-serif text-xl text-slate-purple mb-2">Check gaps and counterexamples</h3><p className="text-sm text-muted-foreground font-sans leading-relaxed">Ask what is absent from the matrix because it is genuinely underrepresented, and what requires more searching, a different term, or a different source type.</p></article>
              <article className="rounded-xl bg-muted/50 p-5"><p className="text-xs font-sans font-semibold text-primary mb-2">STEP 7 · ASSERT</p><h3 className="font-serif text-xl text-slate-purple mb-2">Turn labels into claims</h3><p className="text-sm text-muted-foreground font-sans leading-relaxed">Turn labels into cautious, cited assertions that say what grouped sources collectively show, where they differ, and why the relationship matters.</p></article>
              <article className="rounded-xl bg-muted/50 p-5"><p className="text-xs font-sans font-semibold text-primary mb-2">STEP 8 · VERIFY</p><h3 className="font-serif text-xl text-slate-purple mb-2">Read back with responsibility</h3><p className="text-sm text-muted-foreground font-sans leading-relaxed">Check each interpretation against original material, cite close to borrowed ideas, follow local rules, and keep only claims you can explain and support.</p></article>
            </div>
          </section>
          <section className="max-w-5xl mx-auto mt-7 p-7 bg-white border border-border rounded-2xl">
            ...
            <p className="text-sm text-foreground/80 font-sans leading-relaxed">
              <strong>This entire fictional learning example, including the table, is invented for practice; it is not student work, research evidence, or text to submit.</strong>{" "}
