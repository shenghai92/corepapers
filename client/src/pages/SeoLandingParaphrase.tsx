      ...
      <main className="pt-24 pb-16 min-h-screen bg-background">
        <div className="container">
          ...
          <section className="max-w-5xl mx-auto mb-10 p-7 bg-white border border-border rounded-2xl shadow-card">
            ...
            <h2 className="font-serif text-3xl text-slate-purple mb-5">An eight-step academic paraphrasing workflow</h2>
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
              <article className="rounded-xl bg-muted/50 p-5"><p className="text-xs font-sans font-semibold text-primary mb-2">1. RECORD</p><h3 className="font-serif text-xl text-slate-purple mb-2">Keep source and version details</h3><p className="text-sm text-muted-foreground font-sans leading-relaxed">Note author or organization, title, container, version, date, page or locator, stable link, and required citation system before revision.</p></article>
              <article className="rounded-xl bg-muted/50 p-5"><p className="text-xs font-sans font-semibold text-primary mb-2">2. UNDERSTAND</p><h3 className="font-serif text-xl text-slate-purple mb-2">Read for the full idea</h3><p className="text-sm text-muted-foreground font-sans leading-relaxed">Read passage and context until you can explain claim, evidence, qualification, scope, and purpose without relying on original wording.</p></article>
              <article className="rounded-xl bg-muted/50 p-5"><p className="text-xs font-sans font-semibold text-primary mb-2">3. SELECT</p><h3 className="font-serif text-xl text-slate-purple mb-2">Choose what your point needs</h3><p className="text-sm text-muted-foreground font-sans leading-relaxed">Identify limited idea, result, definition, contrast, or limitation that genuinely advances your paragraph—not every source detail.</p></article>
              <article className="rounded-xl bg-muted/50 p-5"><p className="text-xs font-sans font-semibold text-primary mb-2">4. REBUILD</p><h3 className="font-serif text-xl text-slate-purple mb-2">Set source aside</h3><p className="text-sm text-muted-foreground font-sans leading-relaxed">Explain selected meaning in new structure, sequence, and emphasis that fit your claim. Do not preserve the source’s sentence route through synonym swaps.</p></article>
              <article className="rounded-xl bg-muted/50 p-5"><p className="text-xs font-sans font-semibold text-primary mb-2">5. COMPARE</p><h3 className="font-serif text-xl text-slate-purple mb-2">Check accuracy and distance</h3><p className="text-sm text-muted-foreground font-sans leading-relaxed">Return to source and correct shifts in scope, certainty, evidence, population, setting, period, or meaning.</p></article>
              <article className="rounded-xl bg-muted/50 p-5"><p className="text-xs font-sans font-semibold text-primary mb-2">6. MARK</p><h3 className="font-serif text-xl text-slate-purple mb-2">Handle exact language honestly</h3><p className="text-sm text-muted-foreground font-sans leading-relaxed">Keep unavoidable technical terms or names where needed; quote and mark distinctive borrowed wording under the required style.</p></article>
              <article className="rounded-xl bg-muted/50 p-5"><p className="text-xs font-sans font-semibold text-primary mb-2">7. ATTRIBUTE</p><h3 className="font-serif text-xl text-slate-purple mb-2">Credit borrowed ideas near use</h3><p className="text-sm text-muted-foreground font-sans leading-relaxed">Place required citation or note where readers can see what it supports, including sequences of source-based sentences.</p></article>
              <article className="rounded-xl bg-muted/50 p-5"><p className="text-xs font-sans font-semibold text-primary mb-2">8. REVERSE-CHECK</p><h3 className="font-serif text-xl text-slate-purple mb-2">Confirm before you submit</h3><p className="text-sm text-muted-foreground font-sans leading-relaxed">Compare original, notes, rewrite, quotation marks, citation placement, and complete reference; seek course guidance when uncertain.</p></article>
            </div>
          ...
          <div className="max-w-5xl mx-auto grid lg:grid-cols-[1.3fr_0.9fr] gap-6 mb-10">
            <section className="p-8 bg-white border border-border rounded-2xl">
              ...
              <div className="space-y-4 text-sm text-muted-foreground font-sans leading-relaxed">
                <p><strong className="text-foreground">Fictional learning example. This fictional learning example is invented for practice.</strong> The fictional writer, source, result, citation, paragraph, and revision are not real and cannot be submitted as research evidence or source use. A fictional writer reads a study, identifies only the limitation relevant to a paragraph, closes the source, explains that limit in a new sentence sequence, then reopens the study to check that its scope and cautious wording remain accurate before adding a citation.</p>
